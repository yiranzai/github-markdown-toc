...
@test "TOC for local README.md" {
    ...
    assert_equal "${lines[18]}" "Created by [gh-md-toc](https://github.com/yiranzai/github-markdown-toc)"

}

@test "TOC for remote README.md" {
    run $BATS_TEST_DIRNAME/../gh-md-toc https://github.com/yiranzai/sitemap.js/blob/6bc3eb12c898c1037a35a11b2eb24ababdeb3580/README.md
    assert_success
    ...
    assert_equal "${lines[6]}"  "Created by [gh-md-toc](https://github.com/yiranzai/github-markdown-toc)"
}

@test "TOC for mixed README.md (remote/local)" {
    run $BATS_TEST_DIRNAME/../gh-md-toc \
        README.md \
        https://github.com/yiranzai/sitemap.js/blob/6bc3eb12c898c1037a35a11b2eb24ababdeb3580/README.md
    assert_success
    ...
    assert_equal "${lines[16]}"  "   * [sitemap.js](https://github.com/yiranzai/sitemap.js/blob/6bc3eb12c898c1037a35a11b2eb24ababdeb3580/README.md#sitemapjs)"
    assert_equal "${lines[17]}"  "      * [Installation](https://github.com/yiranzai/sitemap.js/blob/6bc3eb12c898c1037a35a11b2eb24ababdeb3580/README.md#installation)"
    assert_equal "${lines[18]}"  "      * [Usage](https://github.com/yiranzai/sitemap.js/blob/6bc3eb12c898c1037a35a11b2eb24ababdeb3580/README.md#usage)"
    assert_equal "${lines[19]}"  "      * [License](https://github.com/yiranzai/sitemap.js/blob/6bc3eb12c898c1037a35a11b2eb24ababdeb3580/README.md#license)"
    assert_equal "${lines[20]}"  "Created by [gh-md-toc](https://github.com/yiranzai/github-markdown-toc)"
}
...
@test "TOC for non-english chars, #6, #10" {
    run $BATS_TEST_DIRNAME/../gh-md-toc \
        https://github.com/yiranzai/envirius/blob/f939d3b6882bfb6ecb28ef7b6e62862f934ba945/README.ru.md
    assert_success
